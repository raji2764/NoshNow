  ...
  return (
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
      <div className='flex items-center'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Nosh
      ...
      <div className='hidden lg:flex space-x-4'>
        ...
        <Link to='/about' className='font-bold px-5'>About</Link>
        <Link to='/service' className='font-bold px-5'>Services</Link>
          ...
          <div className='fixed top-0 left-0 h-screen bg-white w-60 lg:w-80 shadow z-50 overflow-y-auto'>
            <div className='p-4'>
              <div className='flex items-center mb-4'>
                ...
                <h2 className='text-2xl font-semibold'>Nosh<span className='text-orange-700 font-bold'>Now</span></h2>
              </div>
