...
const About = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-semibold text-gray-800 mb-4">About NoshNow</h1>
      <p className="text-lg text-gray-700 leading-relaxed">
        Welcome to NoshNow, where we are passionate about bringing delicious meals right to your doorstep.
      </p>
      <p className="text-lg text-gray-700 leading-relaxed mt-4">
        NoshNow was founded with a simple mission: to make ordering food convenient, enjoyable, and reliable for everyone. Whether you are craving a hearty dinner after a long day at work or hosting a gathering with friends, we are here to satisfy your hunger with a wide selection of mouthwatering dishes from top local restaurants.
      </p>
      <p className="text-lg text-gray-700 leading-relaxed mt-4">
        Our team is dedicated to providing exceptional service and ensuring that every order is delivered promptly and with care. With NoshNow, you can expect:
      </p>
      ...
      <p className="text-lg text-gray-700 leading-relaxed mt-4">
        Thank you for choosing NoshNow. We look forward to serving you and helping you discover new flavors that delight your taste buds!
      </p>
    </div>
  );
};
